export default {
    "ru": {
        ...
        help: {
            ...
            title: "/title - Напиши свой титул через пробел и он будет присвоен одному случайному пользователю вашей группы. Посмотреть список последних 15 титулов можно командой /titles\n\n",
