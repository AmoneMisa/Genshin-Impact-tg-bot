...
const GUIDES = [
  ...
  { id: 'contact', icon: '💬', title: 'Связь с разработчиком', text: 'Для вопросов, багов и предложений пока используется /feedback. Этот сценарий оставлен в Telegram, потому что там сохраняется двусторонняя переписка с разработчиком.' },
];
