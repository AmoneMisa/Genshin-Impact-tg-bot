export default [
    ...
    {name: "Крохотное зелье ХП", cost: 750, time: 1, command: "potionHp1000", message: "ты получил зелье восстановления хп на 1000 единиц", category: "player"},
    {name: "Маленькое зелье ХП", cost: 1850, time: 1, command: "potionHp3000", message: "ты получил зелье восстановления хп на 3000 единиц", category: "player"},
    {name: "Среднее зелье ХП", cost: 4250, time: 1, command: "potionHp8000", message: "ты получил зелье восстановления хп на 8000 единиц", category: "player"},
    {name: "Крохотное зелье МП", cost: 5000, time: 1, command: "potionMp180", message: "ты получил зелье восстановления мп на 180 единиц", category: "player"},
    {name: "Малое зелье МП", cost: 8800, time: 1, command: "potionMp300", message: "ты получил зелье восстановления мп на 300 единиц", category: "player"},
